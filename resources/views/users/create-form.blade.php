...
@section('content')
    <form action="{{ route('users.create') }}" method="post">
        ...
        <div class="app-cmp-form-detail">
            ...
            <input type="email" id="app-inp-email" name="email" value="{{ old('email') }}" required class="app-cl-code" />

            <label for="app-inp-password">Password</label>
            <input type="password" id="app-inp-password" name="password" value="{{ old('password') }}" required />
