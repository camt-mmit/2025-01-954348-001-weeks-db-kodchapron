...
@section('content')
    <form action="{{ route('shops.update', [
        ...
        <div class="app-cmp-form-detail">
            ...
            <input type="text" id="app-inp-code" name="code" value="{{ old('code', $shop->code) }}" required class="app-cl-code" />

            <label for="app-inp-name">Name</label>
            <input type="text" id="app-inp-name" name="name" value="{{ old('name', $shop->name) }}" required />

            <label for="app-inp-owner">Owner</label>
            <input type="text" id="app-inp-owner" name="owner" value="{{ old('owner', $shop->owner) }}" required />

            <label for="app-inp-latitude">Latitude</label>
            <input type="number" id="app-inp-latitude" name="latitude" value="{{ old('latitude', $shop->latitude) }}" step="any"
                required />

            <label for="app-inp-longitude">Longitude</label>
            <input type="number" id="app-inp-longitude" name="longitude" value="{{ old('longitude', $shop->longitude) }}" step="any"
                required />
